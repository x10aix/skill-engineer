...
| 11 | **CHANGELOG-Qualitaet** | Enthaelt CHANGELOG.md (und ggf. CHANGELOG.de.md) fuer jede Aenderung: (a) Was geaendert wurde, (b) Warum (Root Cause / Anlass), (c) Falls Bugfix: welche Annahme war falsch? Ein Eintrag der nur Fix oder Update enthaelt ist **nicht ausreichend**. |

**Anti-Halluzinations-Checkliste (Pflicht fuer Kriterium 9):**
